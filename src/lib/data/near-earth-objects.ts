...
export function getDummyNearEarthObjectsData(): NearEarthObjectsData {
    return {
        objects: [
            {
                name: '2025 AX7',
                estimatedDiameter: { min: 140, best: 200, max: 310 },
                isHazardous: true,
            ...
            {
                name: '2025 BQ3',
                estimatedDiameter: { min: 45, best: 75, max: 100 },
                isHazardous: false,
            ...
            {
                name: '2025 CR1',
                estimatedDiameter: { min: 520, best: 800, max: 1160 },
                isHazardous: true,
            ...
            {
                name: '2025 DM5',
                estimatedDiameter: { min: 22, best: 35, max: 49 },
                isHazardous: false,
            ...
            {
                name: '2025 EF2',
                estimatedDiameter: { min: 210, best: 350, max: 470 },
                isHazardous: true,
